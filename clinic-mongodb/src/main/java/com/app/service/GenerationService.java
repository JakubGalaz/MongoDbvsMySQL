...
public class GenerationService {
    ...
    public GenerationService(MedicineRepository medicineRepository, PharmaceuticalCompanyRepository pharmaceuticalCompanyRepository, AddressRepository addressRepository, PatientRepository patientRepository, DoctorRepository doctorRepository, MedicalVisitRepository medicalVisitRepository, OutpatientClinicRepository outpatientClinicRepository) {
        ...
        for(int i = 0; i < NUMBER_OF_MEDICINES; i++){
            ...
            medicineRepository.save(
                    new Medicine(
                            ...
                            ThreadLocalRandom.current().nextDouble(1d, 20d),
            ...
            for(int j = 0; j <numberOfMedicines; j++){
                prescriptionItems.add(
                        new PrescriptionItem(
                                ...
                                ThreadLocalRandom.current().nextDouble(1d, 5d)
                        )
                );
            }
