...
public class MedicineController {
    ...
    public String addMedicine(@Valid @ModelAttribute("medicine") Medicine medicine, BindingResult bindingResult){
        ...
        System.out.println("MONGO- ADD MEDICINE: " + executionTime);
    ...
    public String showMedicines(Model model){
        ...
        long executionTime = System.currentTimeMillis() - millisActualTime; //
        System.out.println("MONGO- QUERY FIND ALL MEDICINES: " + executionTime);
    ...
    public String showMedicine(@PathVariable("id") String id, Model model){

        long millisActualTime = System.currentTimeMillis(); // początkowy czas w milisekundach.
        Medicine medicine = medicineRepository.findFirstById(id);
        long executionTime = System.currentTimeMillis() - millisActualTime; //
        System.out.println("MONGO- QUERY FIND ONE MEDICINE: " + executionTime);
        model.addAttribute("medicine", medicine);
    ...
    public String prepareToEditMedicine(@PathVariable("id") String id, Model model){
        Medicine medicine = medicineRepository.findFirstById(id);
        List <PharmaceuticalCompany> pharmaceuticalCompanies = pharmaceuticalCompanyRepository.findAll();
        model.addAttribute("medicine", medicine);
        model.addAttribute("pharmaceuticalCompanies", pharmaceuticalCompanies);
    ...
    public String edit(@PathVariable("id") String id, @Valid @ModelAttribute("medicine") Medicine medicine, Model model){
        long millisActualTime = System.currentTimeMillis(); // początkowy czas w milisekundach.
        medicineRepository.save(medicine);
        long executionTime = System.currentTimeMillis() - millisActualTime; //
    ...
    public String deleteMedicine(@PathVariable("id") String id, Model model){
        Medicine medicine = medicineRepository.findFirstById(id);
